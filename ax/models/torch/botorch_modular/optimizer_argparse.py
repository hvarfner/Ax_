...
from botorch.acquisition.prior_monte_carlo import qPriorKnowledgeGradient
...
@optimizer_argparse.register(qPriorKnowledgeGradient)
def _argparse_kg(
    acqf: qPriorKnowledgeGradient,
    q: int,
    bounds: torch.Tensor,
    num_restarts: int = 40,
    raw_samples: int = 1024,
